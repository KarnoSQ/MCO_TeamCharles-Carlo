...
public class BattleScreenView {
    ...
    private void printEnemyStats(Creature creature){
    ...
    private void printEnemyHP(Creature creature) {
    ...
    private void printActiveCreatureStats(Creature creature){
    ...
    private void printButtons(Creature creature){
